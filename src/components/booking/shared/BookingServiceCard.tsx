...
export function BookingServiceCard({
  ...
  if (variant === "public") {
    return (
      <article
        className={cn(
          "flex h-full flex-col rounded-[1.35rem] border border-border bg-card p-4 shadow-[0_18px_38px_-34px_rgba(120,90,60,0.35)] transition-all hover:border-champagne hover:shadow-[0_24px_44px_-36px_rgba(120,90,60,0.45)]",
  ...
  return (
    ...
    >
      ...
      <ServiceMeta service={service} className="mt-3 text-xs">
        {showAction ? (
