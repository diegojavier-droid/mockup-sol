...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sol-Mai-Peluqueria-maqueta" },
      { name: "description", content: "Mockup del sistema Sol Mai Peluquería" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Sol-Mai-Peluqueria-maqueta" },
      { property: "og:description", content: "Mockup del sistema Sol Mai Peluquería" },
